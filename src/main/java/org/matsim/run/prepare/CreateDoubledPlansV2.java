...
final class CreateDoubledPlansV2 {
	...
	public static void main(String[] args) {
		...
		String intermediateOutputFilePopulation = "./input/v2024.2/lausitz-v2024.2-25.0-pct-plans-cloning-Intermediate.xml.gz";

		String outputFilePopulation = "./input/v2024.2/lausitz-v2024.2-25.0-pct-plans-doubled.xml.gz";

		createClonedIntermediatePopulation(inputFilePopulation, intermediateOutputFilePopulation, "d");
