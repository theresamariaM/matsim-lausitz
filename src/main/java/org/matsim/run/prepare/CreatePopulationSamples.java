...
final class CreatePopulationSamples {
	...
	public static void main(String[] args) {
		...
		String outputFilePopulationPart2 = "-pct-plans";
		String outputFilePopulationPart3 = ".xml.gz";
		//double Sample = 1.0;
		double[] sampleSizes = {0.01, 0.05, 0.1, 0.25, 0.5};
		for (int index = 0; index < sampleSizes.length; index++) {
			...
			if (sampleSize == 0.01 || sampleSize == 0.05 || sampleSize == 0.1) {
				for (int i = 1; i <= 10; i++) {
					...
					String outputFilePopulation = outputFilePopulationPart1 + sampleSizeString + outputFilePopulationPart2 + space + versionNr + outputFilePopulationPart3;
